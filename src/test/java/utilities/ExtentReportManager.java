...
public class ExtentReportManager implements ITestListener{
	...
	public void onStart(ITestContext testContext)
	{
		...
		sparkReporter= new ExtentSparkReporter(".\\Reports\\"+repName); //specify the location of the file you want to store
	...
	public void onTestSkipped(ITestResult result)
	{
		...
		public void onFinish(ITestContext testContext)
		{
			 ...
			 * email.setAuthenticator(new DefaultAuthenticator("poojasabbani@gmail.com","password");
			 * email.setSSLOnConnection(true);
			 * email.setFrom("poojasabbani@gmail.com");
